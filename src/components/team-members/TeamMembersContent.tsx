  ...
  return (
    <DashboardContent>
      <div className="flex flex-col min-h-[calc(100vh-4rem)]">
        <div className="sticky top-16 flex-none space-y-4 p-4 dark:bg-black/10 bg-white/70 z-10 transition-shadow duration-200 before:absolute before:inset-0 before:backdrop-blur-md before:backdrop-blur-[8px] before:-z-10 before:bg-gradient-to-b before:from-transparent before:to-transparent relative">
          <TeamMembersHeader 
            view={view} 
