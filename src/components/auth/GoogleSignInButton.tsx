  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          fill="#EA4335"
          d="M248 504C110.8 504 0 393.2 0 256S110.8 8 248 8"
        />
        <path
          fill="#34A853"
          d="M248 504c137.2 0 248-110.8 248-248S385.2 8 248 8"
        />
        <path
          fill="#FBBC05"
          d="M248 88c-93.1 0-168.7 75.6-168.7 168s75.6 168 168.7 168"
        />
      </svg>
      Sign Up with Google
    </Button>
