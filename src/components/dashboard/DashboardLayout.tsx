    ...
    <Sheet>
      ...
      <SheetContent side="left" className="w-72 p-0 bg-white">
        <div className="flex h-full flex-col">
          <div className="h-16 flex items-center border-b p-4 bg-gradient-to-r from-brand-600 to-brand-700">
            <Logo />
          </div>
          <SidebarContent>
            <SidebarGroup>
    ...
    <SidebarProvider defaultOpen={false}>
      <div className="flex min-h-screen w-full">
        ...
        <Sidebar variant="sidebar" collapsible="icon" className="hidden md:flex bg-white border-r">
          <SidebarHeader className="h-16 flex items-center border-b px-4 bg-gradient-to-r from-brand-600 via-brand-700 to-brand-600">
        ...
        <div className="flex w-full flex-col">
          <header className="h-16 flex items-center justify-between border-b bg-gradient-to-r from-brand-600 via-brand-700 to-brand-600 px-4 sticky top-0 z-50 shadow-sm">
