...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 relative overflow-hidden">
      {/* Background Shapes */}
      <div className="absolute -top-20 -left-20 opacity-[0.08] rotate-45">
      ...
      <div className="absolute top-1/2 -right-20 transform -translate-y-1/2 opacity-[0.08]">
      ...
      <div className="absolute -bottom-10 left-1/3 opacity-[0.08] -rotate-12">
